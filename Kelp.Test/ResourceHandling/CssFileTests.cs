...
namespace Kelp.Test.ResourceHandling
{
	...
	{
		private static readonly string stylePath = Utilities.GetStylePath("stylesheet1.css");
		private static CssFile file;
		...
		private It Should_not_be_empty = () => file.Content.ShouldNotBeEmpty();
		private It Should_contain_child_stylesheets = () => file.Content.ShouldContain("#example1");
		private It Should_contain_child_stylesheets2 = () => file.Content.ShouldContain("url(image1.jpg)");
	}
}
